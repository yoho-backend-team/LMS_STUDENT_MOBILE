        ...
        questions: [
          {
            ...
            explanation:
              "Third person singular (he/she/it) requires 's' or 'es' at the end of the verb in present tense.",
          },
          {
            ...
            explanation:
              'A professional introduction should include a greeting and your full name.',
          },
          {
          ...
          },
          {
            ...
            explanation:
              'Keep professional introductions focused on your role and relevant information.',
          },
          {
            ...
            explanation:
              "End with a polite phrase like 'nice to meet you' or 'looking forward to working with you'.",
          },
        ],
      },
      {
    ...
    children: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            explanation:
              'Trust is built through consistent, honest behavior and demonstrated competence.',
          },
          {
            ...
            <View key={index} style={{ marginBottom: 8, paddingHorizontal: 8 }}>
                ...
                {isUnlocked ? (
                  ...
                  <View style={[styles.inactiveStep, { opacity: 0.3 }]}>
                    {step.icon && (
                      <Image
                        source={step.icon}
                        style={[styles.icon, { tintColor: COLORS.text_title }]}
                      />
                    )}
                    <Text style={styles.inactiveText}>{step?.steptitle} 🔒</Text>
                  </View>
                )}
              </TouchableOpacity>
              ...
              {isActive &&
                ...
                step.children.map((child, childIndex) => {
                  const childUnlocked = unlockedChildren[index]?.includes(childIndex);
                  return (
                    <TouchableOpacity
                      key={childIndex}
                      style={[styles.childStep, !childUnlocked && { opacity: 0.3 }]}
                      disabled={!childUnlocked}
                      onPress={() => handleChildPress(index, step?.steptitle, child, childIndex)}>
