...
const Profile = () => {
  ...
  const tabs = [
    { id: "profile", label: "Profile Information", icon: require("../../assets/profile/profile.png")  },
...
<View style={styles.card}>
  <Image
    source={require("../../assets/profile/card1.png")}
...
<View style={styles.card}>
  <Image
    source={require("../../assets/profile/card2.png")}
    style={styles.cardImage}
  />
 ...
 const renderContent = () => {
  ...
  <View style={styles.card}>
    ...
    <Image
      source={require("../../assets/profile/grl.png")}
      style={styles.cardImag}
    />
