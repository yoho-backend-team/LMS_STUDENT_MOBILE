...
const Attendance = () => {
  ...
  const cards = [
    { id: 1, title: "Classes Atten", attended: attendance?.data?.attendedClassCount, total: attendance?.data?.totalWorkingDays, img: require("../../assets/attendace/attengraph1.png") },
