...
const AttendanceCards = ({ attendance }: AttendanceProps) => {
  const cards = [
    { 
      ...
      attended: attendance?.data?.attendedClassCount || 45, 
      total: attendance?.data?.totalWorkingDays || 60,
      color: "#6366F1", 
      bgColor: "#EEF2FF"
    },
    { 
      id: 2, 
      title: "Present Days", 
      attended: attendance?.data?.totalPresentDays || 52, 
      total: attendance?.data?.totalWorkingDays || 60,
      color: "#059669", 
      bgColor: "#ECFDF5"
    },
    { 
      id: 3, 
      title: "Absent Days", 
      attended: attendance?.data?.totalAbsentDays || 8, 
      total: attendance?.data?.totalWorkingDays || 60,
      color: "#DC2626", 
      bgColor: "#FEF2F2"
    },
