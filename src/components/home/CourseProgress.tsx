    ...
    <View style={styles.container}>
      ...
      <View style={styles.chartContainer}>
        <View style={styles.progressContainer}>
          ...
          {/* Sun Icon */}
          <View style={[styles.iconContainer, styles.sunContainer, {
            left: sunX + 20 - 16,
            top: sunY + 20 - 16,
          }]}>
           <Image source={require('../../assets/home/moon.png')} style={{ width: 30, height: 30 }} />
          
          </View>
          
          {/* Moon Icon */}
          <View style={[styles.iconContainer, styles.moonContainer, {
            left: moonX + 20 - 16,
            top: moonY + 20 - 16,
          }]}>
         <Image source={require('../../assets/home/sun.png')} style={{ width: 30, height: 30 }} />
          </View>
